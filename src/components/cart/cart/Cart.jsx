...
export default function Cart() {
    ...
    return (
        <div id="content"> 
                    ...
                    <ul className="row cart-details" key={product.id}>
                        ...
                        <li className="col-sm-1">
                            <div className="position-center-center">
                                ...
                                <div className="amount" style={{width:"200px", marginLeft:"-65px",fontWeight: "bold"}}>
                        ...
                        <li className="col-sm-1">
                        <div className="position-center-center"> <button style={{backgroundColor: "Transparent", backgroundRepeat: "no-repeat", border: "none",fontSize: "20px"}} onClick={() => removeProduct(product.id)}><i className="icon-close" /></button> </div>
                        </li>
                    </ul>
                    ))
                }
            ...
            <section className="padding-bottom-100 light-gray-bg shopping-cart small-cart">
            <div className="container"> 
