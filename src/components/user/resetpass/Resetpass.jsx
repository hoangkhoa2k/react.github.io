...
export default function Forgotpass({Login}) {
    return (
        <div style={{padding:"16px"}}>
            <h2 style={{textAlign:"center"}}>Đổi Mật Khẩu</h2> <br/>
            <form className="form" style={{marginLeft:"470px"}}>
                <div className="container">
                    <label htmlFor="Username"><b>Email:</b></label><br />
                    <input className="input" type="text" placeholder="Email..." name="Username" id="Username"/><br />
                    ...
                    <button type="submit"  className="button">Xác nhận</button>
                </div>
            </form>
        </div>
    );
